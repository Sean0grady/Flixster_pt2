...
class MainActivity : AppCompatActivity() {
    ...
    //1 - define a data model class as data source - d
    //2 - add recycler view to layout - d
    //3 create a custom row layout XML file to visualize item - d
    //4. create an Adapter and viewHolder to render item
